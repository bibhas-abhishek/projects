...
public class HuffmanCode {
    ...
    public void buildTree(char[] val, int[] freq) {
    ...
    public String decodeString(String s) {
        ...
        decodeStringUtil(root, s, 0, result);
        for (char ch : result)
            builder.append(ch);
    ...
    private void decodeStringUtil(HuffmanNode node, String s, int index, List<Character> result) {
        if (node == null)
            return;
